import { o as objectType, r as recordType, s as stringType } from './chunks/astro/server_C0kEAT-t.mjs';
import { g as getActionQueryString, a as astroCalledServerError, A as ActionError, d as deserializeActionResult, b as ACTION_QUERY_PARAMS, c as appendForwardSlash } from './chunks/astro-designed-error-pages_DX22LGC9.mjs';
import { f as fetchFromNasa } from './chunks/nasa_BTXFcydh.mjs';
import { d as defineAction } from './chunks/server_DgYkLQ6y.mjs';
...
const server = {
  comment: defineAction({
    ...
    input: objectType({
      path: stringType(),
      params: recordType(stringType()).optional()
    }),
    handler: async (input) => {
      return fetchFromNasa(input.path, input.params);
    }
  })
};
